            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo URLROOT; ?>/Dashborad/HomePage/covers">HomePage</a> </li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Add new Carrousel Cover </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form id="newCategory" action="<?php echo URLROOT; ?>/Dashborad/HomePage/addCover" enctype="multipart/form-data" method="post">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="coverTitle">Cover Title</label>
                                            <input type="text" name="coverTitle" class="form-control" id="coverTitle" placeholder="Cover Title">
                                        </div>
                                        <div class="form-group">
                                            <label for="coverLink">Cover Link</label>
                                            <input type="text" name="coverLink" class="form-control" id="coverLink" placeholder="Link">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="CoverSubTitle">Cover Sub-Title</label>
                                            <input type="text" name="CoverSubTitle" class="form-control" id="CoverSubTitle" placeholder="Enter Cover Sub-Title">
                                        </div>
                                        <div class="form-group" style="position: relative;top: 38px;left: 27px;" <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input custom-control-input-danger custom-control-input-outline" type="checkbox" name="coversatus" id="coversatus" checked="true">
